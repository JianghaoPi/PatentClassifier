...
if parallel_computing==0:
    ...
    for i in range(len(problems)):
        ...
        models.append(t)
    print("Exercise 2 with LIBLINEAR training finished in %f."%(time.clock()-time_start))
    time_start = time.clock()
    ...
    print("Exercise 2 with LIBLINEAR predicting finished in %f."%(time.clock()-time_start))
else:
    time_start = time.clock()
    ...
    for i in range(len(problems)):
        ...
        for k in range(len(t)):
            p_val[k]=max(p_val[k],t[k])
    print("Exercise 2 with LIBLINEAR training and predicting finished in %f."%(time.clock()-time_start))
TPR=[]
FPR=[]
